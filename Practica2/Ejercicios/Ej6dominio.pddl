  ...
  (:action MOVE-FORWARD-WATER
       ...
       (
          and
              ...
              (or (hasObjectPlayer ?p bikini) (bagObject ?p bikini))
       )
       :effect
       (
          and
  ...
  (:action MOVE-FORWARD-FOREST
       ...
       (
          and
              ...
              (or (hasObjectPlayer ?p zapatilla) (bagObject ?p zapatilla))
       )
       :effect
       (
          and
       ...
       :parameters (?z - zone ?o - object ?p - player ?n - npc)
	     ...
	     (
	        and
              ...
              (increase (actualPoints ?p) (objectScore ?o ?n))
	     )
  )
)
