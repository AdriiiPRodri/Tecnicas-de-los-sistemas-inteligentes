...
; Distribución de los objetos
  ; N  N  N  N  S       N = nothing  A = algorithms  AP = apples  G = gold  R = roses  S = shoes  B = bikini  O = oscars
  ; AP N  N  N  O
  ; N  N  N  N  N
  ; G  N  N  B  N
  ; N  N  R  N  A
...
; Distribución de NPCs
  ; Q  N  K  N  N       P = professor  Q = princess  W = witch  K = prince  L = leonardoDiCaprio
  ; N  N  N  N  N
  ; N  N  W  N  P
  ; N  N  N  N  N
  ; L  N  N  N  N
    ...
    (typesurface z10 bosque)
    (typesurface z11 piedra)
    (typesurface z12 precipicio)
    (typesurface z13 bosque)
...
; Cantidad de objetos actual de los NPCs
  ...
  (atObject manzanas z6)
  (atObject manzanas z7)
  (atObject oscars z10)
