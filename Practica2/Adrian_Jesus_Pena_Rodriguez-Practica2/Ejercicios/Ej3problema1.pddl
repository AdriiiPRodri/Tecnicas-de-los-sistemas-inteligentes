...
; Distribución de NPCs
  ; N  P  N  N  N       P = professor  Q = princess  W = witch  K = prince  L = Leonardo
  ; N  N  N  Q  N
  ; N  N  W  N  N
  ; N  N  K  N  N
  ; L  N  N  N  N
  ...
  (:goal (AND (hasObjectNPC princesa rosas)
              ...
              (< (total-distance) 32) ; Restricción de coste total de movimiento para el ejercicio
              ;(< (total-distance) 31) ; Con 31 no existe ningún plan que nos permita hacerlo
